...
namespace Com.ByteAnalysis.IFacilita.CertiCadSp.Api
{
    public class Program
    {
        ...
        public static void Main(string[] args)
        {
            ...
            Console.Title = "[API] PropertyRegistrationData - Dados Cadastrais do Imóvel";
            LocalLog.WriteLogStart(configuration, "[API] PropertyRegistrationData", "Dados Cadastrais do Imóvel");
