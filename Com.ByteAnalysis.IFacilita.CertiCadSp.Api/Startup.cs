using Com.ByteAnalysis.IFacilita.CertiCadSp.Api.HealthCheck;
...
namespace Com.ByteAnalysis.IFacilita.CertiCadSp.Api
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddSwaggerGen(c =>
            {
                c.SwaggerDoc("v1",
                    ...
                    {
                        Title = "PropertyRegistrationData - Dados Cadastrais do Imóvel",
                        Version = "v1",
                        Description = "RPA para extração da certidão de dados cadastrais do imóvel",
            ...
            services.AddHealthChecks()
                .ForwardToPrometheus()
                .AddMongoDb(Configuration.GetConnectionString("BaseDados"), name: "BaseDados-DadosCadastraisImóvel");
        }
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            app.UseSwaggerUI(c =>
            {
                c.SwaggerEndpoint("/swagger/v1/swagger.json", "Com.ByteAnalysis.IFacilita.CertiCadSp");
            });
        }
