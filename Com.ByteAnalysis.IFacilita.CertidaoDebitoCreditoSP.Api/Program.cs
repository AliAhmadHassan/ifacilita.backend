...
namespace Com.ByteAnalysis.IFacilita.CertidaoDebitoCreditoSP.Api
{
    public class Program
    {
        ...
        public static void Main(string[] args)
        {
            ...
            Console.Title = "[API] TaxDebts - Débitos Relativos a Créditos Tributários Federais e à dívida ativa da União";
            LocalLog.WriteLogStart(configuration, "[API] TaxDebts", "Débitos Relativos a Créditos Tributários Federais e à dívida ativa da União");
            host.Run();
        }
    }
}
