...
namespace Com.ByteAnalysis.IFacilita.CertificateESajSp.Api.HealthCheck
{
    public class SiteHealthCheck : IHealthCheck
    {
        ...
        public SiteHealthCheck(IConfiguration configuration)
        {
            ...
            HealthCheckService.TimeOutInMinutes = _configuration["Site:TimeOutHealthCheck"].ToInt32();
        }
