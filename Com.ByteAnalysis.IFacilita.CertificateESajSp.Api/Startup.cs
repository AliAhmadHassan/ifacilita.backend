using Com.ByteAnalysis.IFacilita.CertificateESajSp.Api.HealthCheck;
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddSwaggerGen(c =>
            {
                c.SwaggerDoc("v1",
                    ...
                    {
                        Title = "DefectsDefined - De feitos Ajuizados",
                        Version = "v1",
                        Description = "RPA para extração da certidão de De feitos Ajuizados",
            ...
            .ForwardToPrometheus()
            .AddMongoDb(Configuration.GetConnectionString("BaseDados"), name: "BaseDados-FeitosAjuizados");
        }
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            app.UseSwaggerUI(c =>
            {
                c.SwaggerEndpoint("/swagger/v1/swagger.json",
                    "Com.ByteAnalysis.IFacilita.CertificateESajSp");
            });
        }
    }
}
