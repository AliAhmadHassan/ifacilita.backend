...
namespace Com.ByteAnalysis.IFacilita.Core.Api.Controllers
{
    ...
    {
        Service.IAddressService service;
        ...
        // POST: api/Address
        [HttpPost]
        public IActionResult Post([FromBody] Entity.Address entity)
        {
        ...
        [HttpPost("batch ")]
        public IActionResult PostBatch([FromBody] List<Entity.Address> entities)
        {
        ...
        // PUT: api/Address/5
        [HttpPut]
        public IActionResult Put([FromBody] Entity.Address entity)
        {
