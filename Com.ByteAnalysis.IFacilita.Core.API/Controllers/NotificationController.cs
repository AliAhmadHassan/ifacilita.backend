...
namespace Com.ByteAnalysis.IFacilita.Core.Api.Controllers
{
    ...
    public class NotificationController : ControllerBase
    {
        ...
        [HttpPost]
        public IActionResult Post([FromBody] Entity.Notification entity)
        {
        ...
        [HttpPost("batch ")]
        public IActionResult PostBatch([FromBody] List<Entity.Notification> entities)
        {
        ...
        [HttpPut]
        public IActionResult Put([FromBody] Entity.Notification entity)
        {
