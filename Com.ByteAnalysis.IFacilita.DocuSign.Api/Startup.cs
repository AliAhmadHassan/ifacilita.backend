using AutoMapper;
using Com.ByteAnalysis.IFacilita.DocuSign.Api.HealthCheck;
using Com.ByteAnalysis.IFacilita.DocuSign.Api.Middleware;
using Com.ByteAnalysis.IFacilita.DocuSign.Application.Mapping;
using Com.ByteAnalysis.IFacilita.DocuSign.IoC;
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddSwaggerGen(c =>
            {
                c.SwaggerDoc("v1",
                    ...
                    {
                        Title = "Com.ByteAnalysis.IFacilita.DocuSign",
                        Version = "v1",
            ...
            services.AddHealthChecks()
                .AddCheck<SiteHealthCheck>("API-DocuSign")
                .ForwardToPrometheus()
                .AddMongoDb(Configuration.GetConnectionString("BaseDados"), name: "BaseDados-DocuSign");
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            app.UseSwaggerUI(c =>
            {
                c.SwaggerEndpoint("/swagger/v1/swagger.json",
                    "Com.ByteAnalysis.IFacilita.DocuSign");
            });
