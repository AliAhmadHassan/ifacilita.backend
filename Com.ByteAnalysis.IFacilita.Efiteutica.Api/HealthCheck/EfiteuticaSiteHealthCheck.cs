...
namespace Com.ByteAnalysis.IFacilita.Efiteutica.Api.HealthCheck
{

    public class EfiteuticaSiteHealthCheck : IHealthCheck
    {
        private readonly IConfiguration _configuration;

        public EfiteuticaSiteHealthCheck(IConfiguration configuration)
        {
        ...
        public async Task<HealthCheckResult> CheckHealthAsync(HealthCheckContext context, CancellationToken cancellationToken = default)
        {
            try
            {
                ...
                var urlHost = new Uri(_configuration["Apis:Site"]);
