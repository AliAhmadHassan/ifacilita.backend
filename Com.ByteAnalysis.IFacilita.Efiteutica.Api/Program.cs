...
namespace Com.ByteAnalysis.IFacilita.Efiteutica.Api
{
    public class Program
    {
        ...
        public static void Main(string[] args)
        {
            ...
            Console.Title = "[API] - Certidão de Situação Fiscal e Enfitêutica do Imóvel";
            LocalLog.WriteLogStart(configuration, "[API] Efiteutica", "Certidão de Situação Fiscal e Enfitêutica do Imóvel");
