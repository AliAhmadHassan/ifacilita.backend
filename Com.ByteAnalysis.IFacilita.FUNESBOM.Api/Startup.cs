using Com.ByteAnalysis.IFacilita.FUNESBOM.Api.HealthCheck;
...
namespace Com.ByteAnalysis.IFacilita.FUNESBOM.Api
{
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddSwaggerGen(c =>
            {
                c.SwaggerDoc("v1",
                    ...
                    {
                        Title = "Com.ByteAnalysis.IFacilita.FUNESBOM.Api",
                        Version = "v1",
            ...
            services.AddHealthChecks()
                .AddCheck<SiteHealthCheck>("Site-Funesbom")
            .ForwardToPrometheus();
        }
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            app.UseSwaggerUI(c =>
            {
                c.SwaggerEndpoint("/swagger/v1/swagger.json",
                    "Com.ByteAnalysis.IFacilita.FUNESBOM.Api");
            });
        }
    }
}
