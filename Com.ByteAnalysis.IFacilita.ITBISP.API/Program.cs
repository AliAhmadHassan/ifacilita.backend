...
namespace Com.ByteAnalysis.IFacilita.ITBISP.API
{
    public class Program
    {
        ...
        public static void Main(string[] args)
        {
            ...
            Console.Title = "[API] ITBI.SP - Impostos de Transmissão de Bens Imóveis";
            LocalLog.WriteLogStart(configuration, "[API] ITBI.SP", "Impostos de Transmissão de Bens Imóveis");
