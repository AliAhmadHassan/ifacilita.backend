using Com.ByteAnalysis.IFacilita.ITBISP.Api.HealthCheck;
...
namespace Com.ByteAnalysis.IFacilita.ITBISP.API
{
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddSwaggerGen(c =>
            {
                c.SwaggerDoc("v1",
                    ...
                    {
                        Title = "ITBI-SP - Impostos de Transmissão de Bens Imóveis",
                        Version = "v1",
                        Description = "RPA para execução do processo de ITBI em São Paulo",
            ...
            .AddCheck<SiteHealthCheck>("Site-ItbiSP")
            .ForwardToPrometheus()
            .AddMongoDb(Configuration.GetConnectionString("BaseDados"), name: "BaseDados-ItbiSP");
        }
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            app.UseSwaggerUI(c =>
            {
                c.SwaggerEndpoint("/swagger/v1/swagger.json",
                    "Com.ByteAnalysis.IFacilita.ITBISP");
            });
        }
    }
}
