using Com.ByteAnalysis.IFacilita.IptuDebit.Api.HealthCheck;
...
namespace Com.ByteAnalysis.IFacilita.IptuDebit.Api
{
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddSwaggerGen(c =>
            {
                c.SwaggerDoc("v1",
                    ...
                    {
                        Title = "IptuDebts - Débitos do IPTU",
                        Version = "v1",
                        Description = "RPA de extração da Certidão que atesta a inexistência de débitos de tributos imobiliários",
            ...
            services.AddHealthChecks()
                .AddCheck<SiteHealthCheck>("Site-DébitosIPTU")
                .ForwardToPrometheus()
                .AddMongoDb(Configuration.GetConnectionString("BaseDados"), name: "BaseDados-DébitosIPTU");
        }
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            app.UseSwaggerUI(c =>
            {
                c.SwaggerEndpoint("/swagger/v1/swagger.json",
                    "Com.ByteAnalysis.IFacilita.IptuDebit");
            });
        }
    }
}
