...
namespace Com.ByteAnalysis.IFacilita.JusticaTrabalho.Api
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddSwaggerGen(c =>
            {
                c.SwaggerDoc("v1",
                    ...
                    {
                        Title = "Com.ByteAnalysis.IFacilita.JusticaTrabalho.Api",
                        Version = "v1",
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            app.UseSwaggerUI(c =>
            {
                c.SwaggerEndpoint("/swagger/v1/swagger.json", "Com.ByteAnalysis.IFacilita.JusticaTrabalho.Api");
            });
        }
    }
}
