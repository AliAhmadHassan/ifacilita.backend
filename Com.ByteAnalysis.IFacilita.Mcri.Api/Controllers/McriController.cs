...
using Com.ByteAnalysis.IFacilita.Mcri.Service;
...
namespace Com.ByteAnalysis.IFacilita.Mcri.Api.Controllers
{
    ...
    [ApiController]
    public class McriController : ControllerBase
    {
        private readonly IMcriService _service;

        public McriController(IMcriService service)
        {
            _service = service;
        }
        ...
        [HttpPost]
        public IActionResult Post([FromBody] CriModel cri)
        {
            try
            {
        ...
        [HttpPut]
        public IActionResult Put([FromBody] CriModel cri)
        {
            try
            {
