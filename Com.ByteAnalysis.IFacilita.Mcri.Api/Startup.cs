using Com.ByteAnalysis.IFacilita.Mcri.Api.HealthCheck;
...
namespace Com.ByteAnalysis.IFacilita.Mcri.Api
{
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddSwaggerGen(c =>
            {
                c.SwaggerDoc("v1",
                    ...
                    {
                        Title = "Com.ByteAnalysis.IFacilita.Mcri",
                        Version = "v1",
            ...
            services.AddHealthChecks()
                .AddCheck<SiteHealthCheck>("Site-Mcri")
            .ForwardToPrometheus()
            .AddMongoDb(Configuration.GetConnectionString("BaseDados"), name: "BaseDados-Mcri");
        }
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            app.UseSwaggerUI(c =>
            {
                c.SwaggerEndpoint("/swagger/v1/swagger.json",
                    "Com.ByteAnalysis.IFacilita.Mcri");
            });
        }
    }
}
