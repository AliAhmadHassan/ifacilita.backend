using Com.ByteAnalysis.IFacilita.Naturgy.Api.HealthCheck;
...
namespace Com.ByteAnalysis.IFacilita.Naturgy.Api
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddSwaggerGen(c =>
            {
                c.SwaggerDoc("v1",
                    ...
                    {
                        Title = "Com.ByteAnalysis.IFacilita.Naturgy.Api",
                        Version = "v1",
            ...
            services.AddHealthChecks()
                .AddCheck<SiteHealthCheck>("Site-Naturgy")
                .ForwardToPrometheus()
                .AddMongoDb(Configuration.GetConnectionString("BaseDados"), name: "BaseDados-Naturgy");
        }
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            app.UseSwaggerUI(c =>
            {
                c.SwaggerEndpoint("/swagger/v1/swagger.json", "Com.ByteAnalysis.IFacilita.Naturgy");
            });
        }
    }
}
