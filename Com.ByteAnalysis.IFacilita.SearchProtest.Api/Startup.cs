using Com.ByteAnalysis.IFacilita.SearchProtest.Api.HealthCheck;
...
namespace Com.ByteAnalysis.IFacilita.SearchProtest.Api
{
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddSwaggerGen(c =>
            {
                c.SwaggerDoc("v1",
                    ...
                    {
                        Title = "SearchProtest - Pesquisa de Protestos",
                        Version = "v1",
                        Description = "RPA para pesquisa de protestos - [https://www.protestosp.com.br/]",
            ...
            .AddCheck<SiteHealthCheck>("Site-BuscaProtesto")
            .ForwardToPrometheus()
            .AddMongoDb(Configuration.GetConnectionString("BaseDados"), name: "BaseDados-BuscaProtesto");
        }
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            app.UseSwaggerUI(c =>
            {
                c.SwaggerEndpoint("/swagger/v1/swagger.json",
                    "Com.ByteAnalysis.IFacilita.SearchProtest.Api");
            });
        }
    }
}
