using Com.ByteAnalysis.IFacilita.ServiceMail.Api.HealthCheck;
using Com.ByteAnalysis.IFacilita.ServiceMail.Service;
using Com.ByteAnalysis.IFacilita.ServiceMail.Service.Impl;
...
namespace Com.ByteAnalysis.IFacilita.ServiceMail.Api
{
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddSwaggerGen(c =>
            {
                c.SwaggerDoc("v1",
                    ...
                    {
                        Title = "Com.ByteAnalysis.IFacilita.ServiceMail",
                        Version = "v1",
            ...
            services.AddHealthChecks()
                .AddCheck<SiteHealthCheck>("SMTP-ServiceEmail")
            .ForwardToPrometheus();
        }
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            app.UseSwaggerUI(c =>
            {
                c.SwaggerEndpoint("/swagger/v1/swagger.json",
                    "Com.ByteAnalysis.IFacilita.ServiceMail.Api");
            });
        }
    }
}
