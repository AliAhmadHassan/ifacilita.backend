using Com.ByteAnalysis.IFacilita.TransfIptuSp.Api.HealthCheck;
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddSwaggerGen(c =>
            {
                c.SwaggerDoc("v1",
                    ...
                    {
                        Title = "Transferencia de IPTU - Mudança de responsável pelo IPTU",
                        Version = "v1",
                        Description = "RPA para a transfência de IPTU",
            ...
            services.AddHealthChecks()
                .AddCheck<SiteHealthCheck>("Site-TransfenciaIPTU")
            .ForwardToPrometheus()
            .AddMongoDb(Configuration.GetConnectionString("BaseDados"), name: "BaseDados-TransfenciaIPTU");
        }
